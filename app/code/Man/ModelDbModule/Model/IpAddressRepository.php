...
use Man\ModelDbModule\Api\Data\IpAddressSearchResultsInterfaceFactory;
use Man\ModelDbModule\Api\IpAddressRepositoryInterface;
use Man\ModelDbModule\Model\ResourceModel\IpAddress as ResourceIpAddress;
use Man\ModelDbModule\Model\ResourceModel\IpAddress\CollectionFactory as IpAddressCollectionFactory;
...
class IpAddressRepository implements IpAddressRepositoryInterface
{
    ...
    public function save(
        ...
        $ipAddressData = $this->extensibleDataObjectConverter->toNestedArray(
            $ipAddress,
            [],
            \Man\ModelDbModule\Api\Data\IpAddressInterface::class
        );
