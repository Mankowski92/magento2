...
use Academy\ModelDbModule\Api\Data\IpAddressSearchResultsInterfaceFactory;
use Academy\ModelDbModule\Api\IpAddressRepositoryInterface;
use Academy\ModelDbModule\Model\ResourceModel\IpAddress as ResourceIpAddress;
use Academy\ModelDbModule\Model\ResourceModel\IpAddress\CollectionFactory as IpAddressCollectionFactory;
...
class IpAddressRepository implements IpAddressRepositoryInterface
{
    ...
    public function save(
        ...
        $ipAddressData = $this->extensibleDataObjectConverter->toNestedArray(
            $ipAddress,
            [],
            \Academy\ModelDbModule\Api\Data\IpAddressInterface::class
        );
